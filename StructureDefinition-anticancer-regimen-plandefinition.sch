...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:PlanDefinition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.org/fhir/us/codex-mopa/StructureDefinition/ocpa-regimen-disease-context']) &lt;= 1">extension with URL = 'http://hl7.org/fhir/us/codex-mopa/StructureDefinition/ocpa-regimen-disease-context': maximum cardinality of 'extension' is 1</sch:assert>
