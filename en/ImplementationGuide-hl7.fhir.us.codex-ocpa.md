# Resource Oncology Guideline and Coverage Authorization (OGCA)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/codex-ocpa/ImplementationGuide/hl7.fhir.us.codex-ocpa",
  "version" : "0.1.0",
  "name" : "CodexOGCAIG",
  "title" : "Oncology Guideline and Coverage Authorization (OGCA)",
  "status" : "draft",
  ...
  "description" : "Standards-based Oncology Guideline and Coverage Authorization (OGCA) framework covering all cancer types, extending Da Vinci CRD/DTR/PAS with mCODE patient context and computable anti-cancer regimen representation. Breast cancer prior authorization is the first concrete use case and data requirements implementation.",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "hl7.fhir.us.codex-ocpa",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "http://hl7.org/fhir/us/codex-ocpa/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Library/BreastCancerPADataRequirements"
      },
      "name" : "Example Data Requirements Library: Breast Cancer Prior Authorization",
      ...
      "exampleCanonical" : "http://hl7.org/fhir/us/codex-ocpa/StructureDefinition/oncology-data-requirements-library"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "exampleCanonical" : "http://hl7.org/fhir/us/codex-ocpa/StructureDefinition/anticancer-regimen-plandefinition"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "exampleCanonical" : "http://hl7.org/fhir/us/codex-ocpa/StructureDefinition/anticancer-regimen-requestgroup"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "exampleCanonical" : "http://hl7.org/fhir/us/codex-ocpa/StructureDefinition/line-of-therapy-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/oncology-data-requirements-library"
      },
      "name" : "Oncology Data Requirements Library",
    ...
    "page" : {
      ...
      },
      {
        ...
        {
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cds-hooks-extension.html"
        }],
        "nameUrl" : "cds-hooks-extension.html",
        "title" : "CDS Hooks Oncology Extension",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        ...
        "title" : "Data Requirements Pattern",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        ...
        {
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "mcode-candidates.html"
        }],
        "nameUrl" : "mcode-candidates.html",
        "title" : "mCODE Candidates",
        "generation" : "markdown"
      },
      {
        "extension" : [{
