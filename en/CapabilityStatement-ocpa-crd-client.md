# Oncology CRD Client Capability Statement - MOPA — Medical Oncology Prior Authorization v0.1.0
...
```json
{
  ...
  "rest" : [{
    ...
    {
      "type" : "Observation",
      "documentation" : "SHALL expose Observation resources (staging, biomarkers, line of therapy, performance status) for CRD service queries.",
      "interaction" : [{
        "code" : "read"
      },
      {
