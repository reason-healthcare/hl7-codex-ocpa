# Example: CDS Hooks order-sign draftOrders Bundle (TH regimen) - Oncology Guideline and Coverage Authorization (OGCA) v0.1.0
...
```json
{
  ...
  "type" : "collection",
  "entry" : [{
    "fullUrl" : "http://hl7.org/fhir/us/codex-ocpa/RequestGroup/THRegimenOrder",
    "resource" : {
  ...
  {
    "fullUrl" : "http://hl7.org/fhir/us/codex-ocpa/MedicationRequest/PaclitaxelMedRequestTH",
    "resource" : {
  ...
  {
    "fullUrl" : "http://hl7.org/fhir/us/codex-ocpa/MedicationRequest/TrastuzumabMedRequestTH",
    "resource" : {
      "resourceType" : "MedicationRequest",
