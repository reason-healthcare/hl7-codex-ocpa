# Change Log - Oncology Guideline and Coverage Authorization (OGCA) v0.1.0
...
* Defined `OncologyAntiCancerRegimenRequestGroup` profile with cycle-day timing and sequential phase ordering
