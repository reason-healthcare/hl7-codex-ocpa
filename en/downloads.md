# Downloads - Oncology Guideline and Coverage Authorization (OGCA) v0.1.0
...
This is an R4 IG. None of the features it uses are changed in R4B, so it can be used as is with R4B systems. Packages for both [R4 (hl7.fhir.us.codex-ocpa.r4)](../package.r4.tgz) and [R4B (hl7.fhir.us.codex-ocpa.r4b)](../package.r4b.tgz) are available.
