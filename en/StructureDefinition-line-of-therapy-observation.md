# Line of Therapy Observation - Oncology Guideline and Coverage Authorization (OGCA) v0.1.0
...
Observation.code uses the local OGCA code system code `line-of-therapy` as a placeholder. A migration request for a LOINC code will be submitted before mCODE STU5. 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.us.codex-ocpa|current/StructureDefinition/line-of-therapy-observation)
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/codex-ocpa/StructureDefinition/line-of-therapy-observation",
  "version" : "0.1.0",
